...
PROMPT Archivo.................: comisiones_psr_C0025_01q.sql
...
/*********************************************************************
              ...
              ----------------------
Se busca en la tabla COM_HEADERS los datos de la SIM y de la activacion

*********************************************************************/
PROMPT *******************************************************************Procesamiento
PROMPT * * *  Creando la AUX_C0025_PRIM_REC_07...
SET TIMING ON
CREATE TABLE AUX_C0025_PRIM_REC_07
TABLESPACE &v_tbs_admin
NOLOGGING 
AS
SELECT /*+ parallel(a,4) parallel(b,4) full(b) */
       a.*
      ,b.hea_upd_esn
      ,b.hea_real_activation_date
      ,b.hea_upd_cellular_number_real
  FROM aux_c0025_prim_rec_07_a a
      ,&v_esquema_rac8.com_headers b
 WHERE a.handle = b.hea_pce_handle(+)
/
SET TIMING OFF
