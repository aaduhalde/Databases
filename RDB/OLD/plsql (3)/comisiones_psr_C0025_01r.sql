...
PROMPT Archivo.................: comisiones_psr_C0025_01r.sql
...
/*********************************************************************
              ...
              ----------------------
Se buscan en la tabla ITEC_PRODUCTS_ITEMS los datos de las tarjetas SIMs

*********************************************************************/
PROMPT *******************************************************************Procesamiento
PROMPT * * *  Creando la AUX_C0025_PROD_ITEMS_01_A...
SET TIMING ON
CREATE TABLE AUX_C0025_PROD_ITEMS_01_A
...
SELECT /*+ parallel(a,4) */
      ...
      ,pri_delivered_date
      ,pri_pos_id
  FROM &v_esquema_rac8.itec_products_items a
 WHERE pri_pos_id IS NOT NULL
   AND pri_delivered_date >= TO_DATE('01012007','ddmmyyyy')
   AND (   pri_first_load_date IS NULL
        OR pri_first_load_date >= TO_DATE('&v_fecha_proceso', 'dd/mm/yyyy') - '&v_dias_atras'
       )
/
SET TIMING OFF
