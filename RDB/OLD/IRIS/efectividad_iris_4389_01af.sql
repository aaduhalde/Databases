...
prompt ****************************************************************
prompt Archivo....: efectividad_iris_4389_01af.sql 
...
PROMPT ****************************************************************
PROMPT ****************************************************************
PROMPT Creando AUX_G4389_IRIS_30
PROMPT ****************************************************************

create TABLE AUX_G4389_IRIS_30
TABLESPACE &v_tbs_admin 
NOLOGGING
AS
SELECT I26.FECHA_RECARGA,
         I26.CELLULAR_NUMBER_CLI,
         I26.HANDLE_CLIENTE,
         I26.ID_NEGOCIO_CLIENTE,
         I26.DESC_NEGOCIO_CLIENTE,
         I26.ID_MERCADO_CLIENTE,
         I26.DESC_MERCADO_CLIENTE,
         I26.SEGMENTO_CLIENTE,
         I27.ID_PACK,
         I26.CANTIDAD_PAQUETES
FROM AUX_G4389_IRIS_26 I26
         JOIN AUX_G4389_IRIS_27 I27
            ON (I26.CELLULAR_NUMBER_CLI = I27.CELLULAR_NUMBER_CLI)
/
