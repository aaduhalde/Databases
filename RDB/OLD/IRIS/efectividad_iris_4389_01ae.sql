...
prompt ****************************************************************
prompt Archivo....: efectividad_iris_4389_01ae.sql 
...
PROMPT ****************************************************************
PROMPT ****************************************************************
PROMPT Creando AUX_G4389_IRIS_29
PROMPT ****************************************************************

create TABLE AUX_G4389_IRIS_29
...
SELECT /*+ parallel(OLCS,4) */
  ...
  OLCS.CESE_CLU_CELLULAR_NUMBER LINEA_CLIENTE, 
  MIN(OLCS.CESE_PKT_ID) ID_PACK, 
  OLCS.CESE_START_DATE FECHA_COMPRA_PACK, 
  OLCS.CESE_CHNL_ID CANAL_PACK  
...
AND OLCS.CESE_START_DATE =
                        ( SELECT MIN(OLCS.CESE_START_DATE)
                               FROM  AUX_G4389_IRIS_24 I24AUX       
                               JOIN &v_esquema_rac8.OL_CELLULAR_SERVICES OLCS
                                  ON (I24AUX.CELLULAR_NUMBER_CLI = OLCS.CESE_CLU_CELLULAR_NUMBER)
                        WHERE  TRUNC(CESE_START_DATE) = '&v_fecha_proceso'
                        AND CESE_START_DATE BETWEEN I24AUX.FECHA_HORA_RECARGA AND (I24AUX.FECHA_HORA_RECARGA + 3/24)
                        AND CESE_CLU_CELLULAR_NUMBER = I24.CELLULAR_NUMBER_CLI
                        )
GROUP BY 
  I24.FECHA_RECARGA,
  I24.CELLULAR_NUMBER_CLI,
  ...
  I24.DESC_MERCADO_CLIENTE,
  I24.SEGMENTO_CLIENTE,
  OLCS.CESE_CLU_CELLULAR_NUMBER , 
  OLCS.CESE_START_DATE , 
  OLCS.CESE_CHNL_ID 
/
