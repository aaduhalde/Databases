...
prompt ****************************************************************
prompt Archivo....: momo_scratchcards_history_3440_01a.sql
...
PROMPT ls -C1 &v_path.momo_scratchcards_history_*_*.csv > &v_path.nuevos_momo_scratchcards_history.dat 
PROMPT chmod 755 &v_path.nuevos_momo_scratchcards_history.dat
PROMPT ****************************************************************

BEGIN  pck_catalogo.sp_insert_dw_monitor('&v_grupo', '&v_pais', 'MENSAJE', 'Inicio de Proceso'); END;
/
	! ls -C1 &v_path.momo_scratchcards_history_*_*.csv > &v_path.nuevos_momo_scratchcards_history.dat
	! chmod 755 &v_path.nuevos_momo_scratchcards_history.dat
  ! rm &v_path.momo_scratchcards_history.log
