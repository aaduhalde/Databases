...
prompt ****************************************************************
prompt Archivo....: momo_scratchcards_history_3440_01c.sql
...
PROMPT ****************************************************************
PROMPT Insertando en tabla G3440_SCRATCHCARDS_HISTORY
PROMPT ****************************************************************

INSERT /*+ append parallel(a,4) */ INTO G3440_SCRATCHCARDS_HISTORY a
(  
   ARCHIVO,
   ESTADO, 
   FECHA_PROCESO
...
SELECT /*+ parallel(n,4) */
       ...
       'SIN PROCESAR', 
       SYSDATE
FROM   AUX_3440_NUEVOS n
WHERE  NOT EXISTS(SELECT * FROM G3440_SCRATCHCARDS_HISTORY p
