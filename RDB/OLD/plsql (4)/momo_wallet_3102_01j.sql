...
prompt ****************************************************************
prompt Archivo....: momo_wallet_3102_01j.sql
...
PROMPT ****************************************************************
PROMPT Insertando en tabla MOMO_WALLET
PROMPT ****************************************************************
...
BEGIN   
   ...
   IF v_continua_secuencia = 'SI' THEN
      ...
      WHERE  act_table_name = 'MOMO_WALLET';
