...
select user() user;
\! echo version: INSERT_DATA monitor_facts_ac1_data_temp;
\! echo aaduhalde@outlook.es;
\! echo _____________________INSERT_DATA monitor_facts_ac1_data_temp;
/* carga de tablas  TEMP*/

INSERT INTO monitor.monitor_facts_ac1_data_temp
