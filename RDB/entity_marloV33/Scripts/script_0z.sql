...
select user() user;
\! echo version: create entity facts;
\! echo aaduhalde@outlook.es;
\! echo ______________________________ create entity;
...
CREATE  TABLE monitor.monitor_assets1 ( 
...
CREATE  TABLE monitor.monitor_facts_assets ( 
	idac1                INT  NOT NULL   AUTO_INCREMENT  PRIMARY KEY,
	name                 VARCHAR(100)  NOT NULL     ,
	datecreate           DATETIME  NOT NULL     ,
	dateexpi             DATETIME  NOT NULL     ,
...
CREATE  TABLE monitor.monitor_facts_account2 ( 
 ...
 CREATE  TABLE monitor.monitor_facts_fixed_cost ( 
...
show tables;
SELECT SYSDATE() TIME_FINISHED_MONITOR;
