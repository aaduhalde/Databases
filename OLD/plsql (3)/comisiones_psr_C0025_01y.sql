...
PROMPT Archivo.................: comisiones_psr_C0025_01y.sql
...
/*********************************************************************
              ...
              ----------------------
Se busca en la tabla PREPAY_CELLULARS_DW el handle asociado a la linea
al momento de la recarga

*********************************************************************/
PROMPT *******************************************************************Procesamiento
PROMPT * * *  Creando la AUX_C0025_PRIM_REC_09...
SET TIMING ON
CREATE TABLE AUX_C0025_PRIM_REC_09
TABLESPACE &v_tbs_admin
NOLOGGING
AS
SELECT /*+ parallel(a,4) parallel(b,4) */
       a.*
      ,b.pce_last_recharge_date
      ,b.pce_hist_recharge_counter
  FROM aux_c0025_prim_rec_08 a
      ,&v_esquema_rac8.prepay_cellulars_dw b
 WHERE a.handle = b.pce_handle
/
SET TIMING OFF
