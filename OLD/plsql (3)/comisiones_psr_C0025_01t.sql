...
PROMPT Archivo.................: comisiones_psr_C0025_01t.sql
...
/*********************************************************************
              ...
              ----------------------
Se buscan en la tabla ITEC_POS_NUMBERS algunos datos de los POS

*********************************************************************/
PROMPT *******************************************************************Procesamiento
PROMPT * * *  Creando la AUX_C0025_PROD_ITEMS_02...
SET TIMING ON
CREATE TABLE AUX_C0025_PROD_ITEMS_02
...
SELECT posp_pos_id
  ...
  FROM (SELECT /*+ parallel(a,4) */
               posp_pos_id
              ,posp_nim
              ,ROW_NUMBER() OVER(PARTITION BY posp_pos_id ORDER BY posp_id) ranking
          FROM &v_esquema_rac8.itec_pos_numbers)
 WHERE ranking = 1
/
SET TIMING OFF
