...
PROMPT Archivo.................: comisiones_psr_C0025_01d.sql
...
/*********************************************************************
              ...
              ----------------------
Se unen los datos de las 3 tablas anteriores para unificar las recargas
y compras de packs

*********************************************************************/
PROMPT *******************************************************************Procesamiento
PROMPT * * *  Creando la AUX_C0025_PRIM_REC_01...
SET TIMING ON
CREATE TABLE AUX_C0025_PRIM_REC_01
...
SELECT /*+ parallel(a,4) */
      ...
      ,monto
      ,origen
      ,1 origen_trx --este campo se agrega para distinguir el origen de la recarga (usado en el proximo script)
  FROM aux_c0025_prim_rec_01_a a
UNION ALL
SELECT /*+ parallel(a,4) */
       fecha_recarga
      ,bill_number
      ...
      ,monto
      ,origen
      ,2 origen_trx --este campo se agrega para distinguir el origen de la recarga (usado en el proximo script)
  FROM aux_c0025_prim_rec_01_b a
UNION ALL
SELECT /*+ parallel(a,4) */
       fecha_recarga
      ,bill_number
      ...
      ,monto
      ,origen
      ,3 origen_trx --este campo se agrega para distinguir el origen de la recarga (usado en el proximo script)
  FROM aux_c0025_prim_rec_01_c a
/
SET TIMING OFF
