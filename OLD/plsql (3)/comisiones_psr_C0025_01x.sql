...
PROMPT Archivo.................: comisiones_psr_C0025_01x.sql
...
PROMPT * * *  Creando la AUX_C0025_PRIM_REC_08...
SET TIMING ON
CREATE TABLE AUX_C0025_PRIM_REC_08
TABLESPACE &v_tbs_admin
NOLOGGING
AS
SELECT /*+ parallel(a,4) parallel(b,4) */
       *
  FROM aux_c0025_prim_rec_07 a
      ,aux_c0025_prod_items_05 b
 WHERE a.hea_upd_esn = b.pri_serie(+)
/
SET TIMING OFF
