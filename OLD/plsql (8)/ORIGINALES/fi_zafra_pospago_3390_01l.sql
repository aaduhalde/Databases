prompt ****************************************************************
prompt Archivo....: fi_zafra_pospago_3390_01l.sql
prompt Autor......: Leandro Mestrallet
prompt
prompt Descripción: Actualizo tabla final detalle con activaciones.
prompt
prompt ****************************************************************
...
prompt ****************************************************************
prompt ELIMINA DATOS DE B_FI_ZAFRA_POSP_ACTIV POR REPROCESO
prompt ****************************************************************
DECLARE
...
BEGIN
  dbms_output.put_line('alter table B_FI_ZAFRA_POSP_ACTIV truncate partition for (to_date(''' ||
                       to_char(fecha, 'dd/mm/yyyy') ||
                       ''',''dd/mm/yyyy''))');
  execute immediate 'alter table B_FI_ZAFRA_POSP_ACTIV truncate partition for (to_date(''' ||
...
/
prompt ****************************************************************
prompt ACTUALIZA TABLA FINAL DETALLADA B_FI_ZAFRA_POSP_ACTIV
prompt ****************************************************************
INSERT /*+ APPEND PARALLEL(b,4) */ 
INTO B_FI_ZAFRA_POSP_ACTIV 
(
FECHA,
ORIGEN, 
PROMO, 
...
where ACT_TABLE_NAME= 'B_FI_ZAFRA_POSP_ACTIV'
/
COMMIT
/
