prompt ****************************************************************
prompt Archivo....: fi_zafra_pospago_3390_01d.sql
prompt Autor......: Leandro Mestrallet
prompt
prompt Descripción: Agrego las líneas sin canal correspondientes al 622.
prompt
prompt ****************************************************************
...
prompt ****************************************************************
prompt Creando Tabla - AUX_3390_ZAFRA_POSP_04
prompt ****************************************************************
CREATE TABLE AUX_3390_ZAFRA_POSP_04 tablespace &V_TBS_ADMIN nologging pctfree 0 AS 
SELECT B.*, NVL(A.CANAL, '622') CANAL
  FROM AUX_3390_ZAFRA_POSP_03 A, AUX_3390_ZAFRA_POSP_01 B
