PROMPT *********************************************************************
PROMPT aux1_traking_wa_G4704
PROMPT *********************************************************************
PROMPT Archivo....: G4704_mkt_dig_traking_wa_01a.sql
PROMPT Autor......: Alejandro Duhalde
PROMPT Reviso.....:
PROMPT Produccion.:
PROMPT Descripcion: Creacion de la tabla aux1_traking_wa_G4704
PROMPT *********************************************************************
...
SELECT 'sf_mkt_dig_traking_wa.csv' val2
FROM DUAL
/
...
SELECT 'D_D_G4704_SF_MKT_DIG_TRAKI' val4
FROM DUAL
/

COLUMN val5 new_value v_path_origen    noprint
SELECT '/exa1desa/desa/G4704/' val5
FROM DUAL
/
...
CREATE TABLE &v_esquema_rac8.aux1_traking_wa_G4704
        ( 
