...
prompt ****************************************************************
prompt Archivo....: efectividad_iris_4389_01s.sql 
prompt Autor......: Soledad Zubizarreta
prompt Reviso.....:
prompt Produccion.:
prompt Descripción: Quitamos aquellos NIM que migraron este mes de PosPago y PrePago
prompt 				
prompt *****************************************************************
...
PROMPT ****************************************************************
PROMPT ****************************************************************
PROMPT Creo Tabla AUX_G4389_IRIS_17
PROMPT ****************************************************************
create TABLE AUX_G4389_IRIS_17
...
AS
 ...
 FROM 
     AUX_G4389_IRIS_16
 WHERE NIM NOT IN (SELECT NIM FROM AUX_G4389_IRIS_13)
/
