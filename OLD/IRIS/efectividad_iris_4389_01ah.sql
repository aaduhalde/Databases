...
prompt ****************************************************************
prompt Archivo....: efectividad_iris_4389_01ah.sql 
prompt Autor......: Miguel Peralta
prompt Reviso.....:
prompt Produccion.:
prompt Descripción: Se buscan todos los packs comprados por las líneas  
prompt 							que participan en las recargas a travez de IRIS.  
prompt 				
prompt *****************************************************************
...
PROMPT ****************************************************************
PROMPT ****************************************************************
PROMPT Creando AUX_G4389_IRIS_32
PROMPT ****************************************************************

create TABLE AUX_G4389_IRIS_32
TABLESPACE &v_tbs_admin 
NOLOGGING
AS
SELECT *                                   
FROM AUX_G4389_IRIS_30
UNION
SELECT *
FROM AUX_G4389_IRIS_31
/
