...
prompt ****************************************************************
prompt Archivo....: efectividad_iris_4389_01q.sql 
prompt Autor......: Soledad Zubizarreta
prompt Reviso.....:
prompt Produccion.:
prompt Descripción: Universo Piramide PrePago
prompt 				
prompt *****************************************************************
...
PROMPT ****************************************************************
PROMPT ****************************************************************
PROMPT Creo Tabla AUX_G4389_IRIS_15
PROMPT ****************************************************************
create TABLE AUX_G4389_IRIS_15
...
SELECT 
     ...
     RANGO_REC_X_3 RANGO
FROM
     &v_esquema_rac8.piramide_prepago
WHERE ANIO_MES_DATE = (SELECT MAX(ANIO_MES_DATE)from &v_esquema_rac8.piramide_prepago)
/
