...
prompt ****************************************************************
prompt Archivo....: efectividad_iris_4389_01p.sql 
prompt Autor......: Soledad Zubizarreta
prompt Reviso.....:
prompt Produccion.:
prompt Descripción: Universo Piramide PosPago
prompt 				
prompt *****************************************************************
...
PROMPT ****************************************************************
PROMPT ****************************************************************
PROMPT Creo Tabla AUX_G4389_IRIS_14
PROMPT ****************************************************************
create TABLE AUX_G4389_IRIS_14
...
SELECT 
     ...
     RANGO
FROM
     &v_esquema_rac8.piramide_pospago
WHERE fecha = (SELECT MAX(FECHA)from &v_esquema_rac8.piramide_pospago)
/
