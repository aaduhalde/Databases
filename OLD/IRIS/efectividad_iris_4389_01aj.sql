...
prompt ****************************************************************
prompt Archivo....: efectividad_iris_4389_01aj.sql 
prompt Autor......: Miguel Peralta
prompt Reviso.....:
prompt Produccion.:
prompt Descripción: Nos quedamos con los datos de las recargas de clientes que no compraron paquetes de datos.  
prompt 				
prompt *****************************************************************
...
PROMPT ****************************************************************
PROMPT ****************************************************************
PROMPT Creando AUX_G4389_IRIS_34
PROMPT ****************************************************************

create TABLE AUX_G4389_IRIS_34
...
WHERE I23.CELLULAR_NUMBER_CLI NOT IN (
