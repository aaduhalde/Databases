...
prompt ****************************************************************
prompt Archivo....: momo_wallet_3102_01b.sql
...
PROMPT ****************************************************************
PROMPT Creando la tabla AUX_3102_NUEVOS desde tabla externa
PROMPT ****************************************************************
WHENEVER SQLERROR CONTINUE
ALTER SESSION SET NLS_NUMERIC_CHARACTERS=',.'
/

CREATE TABLE AUX_3102_NUEVOS
(      
...
(TYPE oracle_loader
 ...
 (      
  ...
  BADFILE 'nuevos_momo_wallet.bad'
  DISCARDFILE 'nuevos_momo_wallet.dis'
  LOGFILE 'nuevos_momo_wallet.log'
  FIELDS TERMINATED BY " "  OPTIONALLY ENCLOSED BY '"'
  MISSING FIELD VALUES ARE NULL
 )
 LOCATION ('nuevos_momo_wallet.dat')
)
